...
from predict_matrix_dynamic import generate_matrix as dynamic_generate_matrix
...
def generate_matrix(name, model_path, output_path, device=torch.device('cpu')):
    return dynamic_generate_matrix(name, model_path, output_path, device)
...
if __name__ == "__main__":
    ...
    # 执行推理
    dynamic_generate_matrix('DAVIS', model_path, output_path, device) 
